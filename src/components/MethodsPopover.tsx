          ...
          <div className="methods-popover">
            ...
            <div className="methods-popover-body">
              <dl>
                ...
                <dd>
                  By default, a greedy compatible-splits consensus from your input gene trees. There is no model of <em>why</em> trees
                  disagree (e.g. incomplete lineage sorting). You can instead supply your own reference tree (e.g. a proper species-tree
                  estimate) when loading data - every branch is then evaluated against that tree instead.
                </dd>
